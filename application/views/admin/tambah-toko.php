        		...
        		<div class="container-fluid">
        			<div class="page-title-box">
        				<div class="row align-items-center">
        					<div class="col-sm-6">
        						<h4 class="page-title">Form Tambah Data Toko</h4>
        					</div>
        					<div class="col-sm-6">
        						<ol class="breadcrumb float-right">
        							<li class="breadcrumb-item"><a href="javascript:void(0);">Form Tambah Data Toko</a></li>
        						</ol>
        					</div>
        				</div> <!-- end row -->
        			</div>
        				...
        				<div class="col-lg-6">
        					<div class="card m-b-30">
        						<div class="card-body">
        							...
        							<?= form_open_multipart('admin/tambahToko'); ?>
        							<div class="form-group">
        								<label>Nama Toko</label>
        								<input type="text" name="toko" class="form-control form-control-lg " placeholder="Nama Toko" value="<?= set_value('toko'); ?>" />
        							</div>
        							<div class="form-group">
        								<label>Lokasi Toko</label>
        								<textarea id="lokasi" type="text" name="alamat" class="form-control form-control-lg " rows="5" placeholder="Alamat Toko"><?= set_value('alamat'); ?></textarea>
        							</div>
        							<div class="form-group">
        								<label>Latitude</label>
        								<input id="lat" type="text" name="latitude" class="form-control form-control-lg " placeholder="Latitude" readonly value="<?= set_value('latitude'); ?>" />
        							</div>
        							<div class="form-group">
        								<label>Longitude</label>
        								<input id="lng" type="text" name="longitude" class="form-control form-control-lg" placeholder="Longitude" readonly value="<?= set_value('longitude'); ?>" />
        							</div>
        							<div class="form-group">
        							...
        							<div class="form-group">
        								...
        								<input type="text" name="no_telp" class="form-control form-control-lg " placeholder="No Telp Toko" value="<?= set_value('no_telp'); ?>" />
        							</div>
        							<div class="form-group">
        								<label>Jam Buka dan Jam Tutup</label>
        								<input type="text" name="jam" id="daterange" class="form-control form-control-lg " placeholder="Jam Buka dan Jam Tutup" value="<?= set_value('jam'); ?>" />
        							</div>
